package com.github.ros.roxanne_sa.stats.dataset.mongo;
...
public class MongoModelDataset implements ModelDataset 
{
	 ...
	 */
	public MongoModelDataset() 
			throws UnknownHostException 
	{
		// create client
		this.client = new MongoClient();
		// get a reference to the DB
		this.db = this.client.getDatabase("roxanne");
	 ...
	 * @throws UnknownHostException
	 */
	public MongoModelDataset(String host) 
			throws UnknownHostException
	{
