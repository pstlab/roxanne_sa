...
import com.github.ros.roxanne_sa.ai.executive.lang.ex.NodeExecutionErrorException;
...
import com.github.ros.roxanne_sa.ai.executive.lang.failure.NodeDurationOverflow;
import com.github.ros.roxanne_sa.ai.executive.lang.failure.NodeExecutionError;
...
import com.github.ros.roxanne_sa.stats.dataset.TokenExecutionData;
			...
			switch (feedback.getType())
			{
				...
				case UNCONTROLLABLE_TOKEN_COMPLETE : 
				{
					...
					try
					{
						...
						// save statistic record to the data-set
						this.executive.dataset.save(
								new TokenExecutionData(
										System.currentTimeMillis(), 
										node.getGroundSignature(), 
										node.getStart()[0], 				// set scheduled start time
										duration,							// set observed duration 
										node.getComponent()));
