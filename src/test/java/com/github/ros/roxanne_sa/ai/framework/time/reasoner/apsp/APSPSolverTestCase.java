package com.github.ros.roxanne_sa.ai.framework.time.reasoner.apsp;
...
import com.github.ros.roxanne_sa.ai.framework.time.tn.SimpleTemporalNetworkWithUncertainty;
...
public class APSPSolverTestCase 
{
	...
	public void example1() {
		try 
		{
			...
			// create temporal network
			SimpleTemporalNetworkWithUncertainty itn = new SimpleTemporalNetworkWithUncertainty(ORIGIN, HORIZON);
			// create APSP solver
	...
	public void example2() {
		try 
		{
			...
			SimpleTemporalNetworkWithUncertainty exTn = new SimpleTemporalNetworkWithUncertainty(ORIGIN, HORIZON);
